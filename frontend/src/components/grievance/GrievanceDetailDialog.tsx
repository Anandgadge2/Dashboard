...
const GrievanceDetailDialog: React.FC<GrievanceDetailDialogProps> = ({ isOpen, grievance, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-black/60 backdrop-blur-sm overflow-y-auto md:p-4">
      <div className="w-full md:max-w-3xl h-[100dvh] md:h-auto md:max-h-[90vh] overflow-hidden rounded-t-3xl md:rounded-2xl shadow-2xl bg-white animate-in slide-in-from-bottom md:zoom-in duration-300 flex flex-col">
        {/* Gradient Header */}
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0">
                  <h2 className="text-base md:text-lg font-bold text-white leading-tight">Grievance Details</h2>
